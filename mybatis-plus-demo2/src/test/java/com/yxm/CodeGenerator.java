...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(path + "/mybatis-plus-demo2/src/main/java");    //设置输出目录
...
//        templateConfig.setEntity(null);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return path + "/mybatis-plus-demo2/src/main/resources/mapper/"  + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
...
//        });
        ...
        strategyConfig.setInclude("user","role");      //设置要映射的表名，可以同时设置多个表 strategyConfig.setInclude("user","...");
